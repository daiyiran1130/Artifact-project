...
Model: google/medgemma-1.5-4b-it (4B, bfloat16, no quantization needed)
...
# 4B 模型 bfloat16 占约 8GB，RTX PRO 6000 显存 96GB 剩余大量可用于 batch
# Prompt 3 会生成较长的推理链，如遇 OOM 可将 BATCH_SIZE 减小为 8
BATCH_SIZE = 16
